...
export class UserRolesApi {
  private readonly apiController: string = 'users-permissions/roles';
  ...
  updateCurrent(item: any): Observable<any> {
    return this.api.put(`${this.apiController}/current?populate=*`, item);
  }

  update(item: any): Observable<any> {
    return this.api.put(`${this.apiController}/${item.id}?populate=*`, item);
  }
